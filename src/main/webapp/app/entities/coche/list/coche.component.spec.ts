...
describe('Coche Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'coche', component: CocheComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.coches?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
